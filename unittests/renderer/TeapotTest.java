...
public class TeapotTest {
    ...
    private final Camera camera = new Camera(new Point(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, 1, 0)) //
            .setVPSize(200, 200).setVPDistance(1000).setImageWriter(imageWriter).setMultithreading(3).setAmountOfSampledRays(17);
    //

    private final Scene scene = new Scene.SceneBuilder("Test scene").setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.15))).build();
